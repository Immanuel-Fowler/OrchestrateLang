...
4. **Landline serverlets** — [build plan](design/landline-serverlets.md): prerequisites, binary values, and protocol v1 are implemented (steps 1–3). Next: Python declarations and SDK (steps 4–5). This supersedes the subprocess+JSON sketch.
