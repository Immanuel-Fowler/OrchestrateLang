...
- A sandboxed serverlet contains its guest's compute, memory, and reach, as well as
  wasmtime does. It carries what the C ABI carries: numbers, booleans, strings, arrays
  of numbers or booleans, and structs of those; an array of strings or structs, or a
  ...
  build, where host functions exist.
