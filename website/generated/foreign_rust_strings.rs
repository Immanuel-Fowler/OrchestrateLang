            ...
            tokio::spawn(async move {
                ...
                loop {
                    let __inner_handle = tokio::spawn(async move {
                        loop {
                            let mut reversed = strings::reverse_string(String::from("Orchestrate"));
                        print_val(OrchAdd::orch_add(String::from("Reversed: "), reversed));
                        let mut vowels = strings::count_vowels(String::from("Orchestrate"));
                        print_val(OrchAdd::orch_add(String::from("Vowel count: "), to_string(vowels)));
                        let mut upper = strings::to_uppercase(String::from("hello world"));
                        print_val(OrchAdd::orch_add(String::from("Uppercase: "), upper));
                        stop_orch();
                        }
                    });
