...
async fn orchestrator_main() {
    // orch:10:5
        ...
        // orch:13:5
        print_val(OrchAdd::orch_add(String::from("Initial count: "), to_string(total)));
        // orch:15:5
        service.increment(5).await;
        // orch:16:5
        tokio::time::sleep(std::time::Duration::from_millis(100 as u64)).await;
        // orch:18:5
        total = service.get_count().await;
        // orch:19:5
        print_val(OrchAdd::orch_add(String::from("Final count: "), to_string(total)));
        // orch:21:5
        stop_orch();
}
