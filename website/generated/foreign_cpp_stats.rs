            ...
            tokio::spawn(async move {
                ...
                loop {
                    let __inner_handle = tokio::spawn(async move {
                        loop {
                            let mut avg = stats::average(10.0, 20.0, 30.0);
                        print_val(OrchAdd::orch_add(String::from("Average(10,20,30): "), to_string(avg)));
                        let mut dev = stats::std_dev_two(4.0, 8.0);
                        print_val(OrchAdd::orch_add(String::from("Std dev(4,8): "), to_string(dev)));
                        let mut biggest = stats::max_of_three(7, 3, 12);
                        print_val(OrchAdd::orch_add(String::from("Max(7,3,12): "), to_string(biggest)));
                        stop_orch();
                        }
                    });
